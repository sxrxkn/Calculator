/*
 ...
 Version     : 1
 Copyright   :
 Description : This is a calculator with lists. It supports operations such as
 on vectors and float numbers(with operations as
 multiplication'*', division'/', addition'+', subtraction'-',
 exponentiation'^',factorial'!') and vectors (with operation as
 addition'+', subtraction'-', scalar multiplication'*'). Data from the file is read to the list.
