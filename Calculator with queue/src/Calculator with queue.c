/*
 ...
 Version     : 1.0
 Copyright   :
 Description : This is a queue calculator implemented via a stack. It is implemented
 to work in Polish notation. It supports operations on float numbers (with operations as
...
int main(int argc,char *argv[]) {
    ...
    while(end == 'n'){ // Repeat the program
            ...
            fprintf(output,"|");
            fclose(output);
            printf("Do you want to continue? Print n for continue or any button for close");
            scanf(" %c", &end);}
    return 0;}
